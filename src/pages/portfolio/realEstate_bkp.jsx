...
const RealEstatePage = () => {
  ...
  const getAllAssetsChartData = async () => {
    ...
    try {
      ...
      // setRealEstateProfit(response?.data?.data?.profitLoss?.profitLossValue);
      // setRealEstateProfitPercent(
      //   response?.data?.data?.profitLoss?.profitLossPercentage
      // );
      // setNetRealEstateProfit(response?.data?.data?.profitLoss?.profitLossValue);
      // setNetRealEstateProfitPercent(
      //   response?.data?.data?.profitLoss?.profitLossPercentage
      // );
          ...
          <div className="w-[100%] xl:w-[76%] bg-[#191919] rounded pt-0 md:pt-[10px] p-[10px] md:p-[24px] relative">
            ...
            {selectedOption === 1 ? (
              ...
              <CommonNetAssetvalueChart
                strokeColor={"#6F50E5"}
                fillColor={"#221F2E"}
                data={navAssetChartData}
                dataKey={"total_realEstate_net_value"}
                dateKey={"year"}
                profit={netRealEstateProfit}
                profitPercent={netRealEstateProfitPercent}
