...
const OtherAssetsPage = () => {
  ...
  const getAllAssetsChartData = async () => {
    ...
    try {
      ...
      // setOtherAssetProfit(response?.data?.data?.profitLoss?.profitLossValue);
      // setOtherAssetProfitPercent(
      //   response?.data?.data?.profitLoss?.profitLossPercentage
      // );
      // setNetOtherAssetProfit(response?.data?.data?.profitLoss?.profitLossValue);
      // setNetOtherAssetProfitPercent(
      //   response?.data?.data?.profitLoss?.profitLossPercentage
      // );
          ...
          <div className="w-[100%] xl:w-[76%] bg-[#191919] rounded pt-0 md:pt-[10px] p-[10px] md:p-[24px] relative">
            ...
            {selectedOption === 1 ? (
              ...
              <CommonNetAssetvalueChart
                ...
                fillColor={"#241C23"}
                data={allAssetsChartData}
                dataKey={"total_otherAsset_net_value"}
                profit={netOtherAssetProfit}
                profitPercent={netOtherAssetProfitPercent}
