...
const EditDebt = () => {
  ...
  console.log(data, "rowData in edit debt");
  ...
  console.log(loanId, "loanId in edit debt");
...
console.log("payfreqId", payFreqId);
  ...
  useEffect(() => {
    if (data[0] === "Mortgage") {
      setLoanId(25);
      setLoanName("Mortgage");
      setLoanText("Mortgage");
    }
    else if (data[0] === "Personal Loan") {
      setLoanId(27);
      setLoanName("Personal Loan");
      setLoanText("Personal Loan");
    } else if (data[0] === "Student Loan") {
      setLoanId(26);
      setLoanName("Student Loan");
      setLoanText("Student Loan");
    }

    if (data[9] === "Monthly") {
      setPayFreqId(28);
      setPayFreqText("Monthly");
    } else if (data[8] === "Quarterly") {
      setPayFreqId(29);
      setPayFreqText("Quarterly");
    }
  }, [data]);
  ...
  const initialValues = {
    priAmount: Number(data[6]),
    stDate: data[8],
    // bName:"",
    intRate: Number(data[1].slice(0, -1)),
    loanTerm: Number(data[2]),
  };
    ...
    try {
      ...
      const successMessage =
        typeof response?.data?.message === "string"
          ...
          : "Successfully edited loan details";
                  ...
                  <div className="flex flex-row justify-between flex-wrap">
                    ...
                    <div className="mt-[20px] sm:-mt-[9px] mb-0 w-[100%] sm:w-[47%]">
                      <AssetPriceInput
                        ...
                        passValue={initialValues.priAmount}
                    ...
                    <div className="mt-[20px] sm:mt-[20px] mb-0 w-[100%] sm:w-[47%]">
                      <AssetInput
                        ...
                        password={false}
                        setFormValues={setFormValues}
                        passValue={initialValues.intRate}
                        isSetFormValues={true}
                        shouldPreventKeys={true}
                    ...
                    <div className="-mt-[24px] sm:-mt-[32px] mb-0 w-[100%] sm:w-[47%]">
                      <AssetInput
                        ...
                        password={false}
                        setFormValues={setFormValues}
                        passValue={initialValues.loanTerm}
                        isSetFormValues={true}
                        shouldPreventKeys={true}
                        // profileSettings={true}
                      />
