            ...
            <div className="flex items-center gap-2">
              <p
                className={`text-[16px] text-lato font-[400] ${
                  realEstateProfitPercent >= 0
                    ? "text-[#1FB98B]"
                    : "text-[#B91F1F]"
                }`}
              >
                {selectedCurencySymbol}
                {FormatNumberWithCommas(realEstateProfit || 0) || 0}
              </p>
              <p
              ...
              >
                <span>{realEstateProfitPercent?.toFixed(2) || 0}% </span>
                {realEstateProfitPercent >= 0 ? (
                  <FaArrowUp />
                ) : (
            ...
            <div className="w-full">
              <ResponsiveContainer width={"100%"} height={345}>
                ...
                >
                  ...
                  <Area
                    type="monotone"
                    dataKey="realEstate_current_value"
                    stroke="#6F50E5"
...
{
  /* <div className="h-[403px] flex justify-center items-center text-[20px] text-roboto">No Data Found</div> */
}
