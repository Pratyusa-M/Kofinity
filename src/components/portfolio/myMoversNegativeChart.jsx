...
const data = [
  ...
  { name: "05/08/2016", uv: 7, pv: 48, amt: 21 },
  {
    name: "06/08/2016",
    uv: 6,
    pv: 38,
...
const MyMoversNegativeChart = ({ moversText }) => {
  return (
      ...
      <div className="w-[100%] mt-[25px] flex items-center justify-between">
        <div>
          ...
          <div className="flex items-center gap-[4px] mt-[5px]">
            <p className="text-[12px] text-lato font-[400] text-[#B91F1F]">
              +$6,000
            </p>
            <p className="w-[56px] h-[18px] text-[10px] text-lato font-[400] text-[#B91F1F] bg-[#2E2E2E] flex items-center justify-center rounded-[2px] gap-1">
              <span>+40% </span>
...
export default MyMoversNegativeChart;
