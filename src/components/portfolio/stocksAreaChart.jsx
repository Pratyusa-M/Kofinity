...
const StocksAreaChart = ({
  ...
  console.log(dateKey, "date key in chart");
  const selectedCurencySymbol = useSelector(SelectedCurrencySymbol);
  console.log(assetValue, "asset value in chart");
  console.log(stockProfit, "stock profit in chart");
  console.log(stockProfitPercent, "stock profit percent in chart");
            ...
            <div className="flex items-center gap-2">
              <p
                className={`text-[16px] text-lato font-[400]  ${
                  stockProfitPercent >= 0 ? "text-[#1FB98B]" : "text-[#B91F1F]"
                }`}
              >
                {selectedCurencySymbol}
                {FormatNumberWithCommas(stockProfit || 0) || 0}
              </p>
              <p
              ...
              >
                <span>{stockProfitPercent?.toFixed(2) || 0}% </span>
