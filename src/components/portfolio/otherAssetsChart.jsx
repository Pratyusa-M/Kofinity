...
const OtherAssetsChart = ({
  data,
  dateKey,
  otherAssetProfit,
  otherAssetProfitPercent,
  assetValue,
}) => {
            ...
            <div className="flex items-center gap-2">
              <p
                className={`text-[16px] text-lato font-[400] ${
                  otherAssetProfitPercent >= 0
                    ? "text-[#1FB98B]"
                    : "text-[#B91F1F]"
                }`}
              >
                {selectedCurencySymbol}
                {FormatNumberWithCommas(otherAssetProfit || 0) || 0}
              </p>
              <p
              ...
              >
                <span>{otherAssetProfitPercent?.toFixed(2) || 0}% </span>
                {otherAssetProfitPercent >= 0 ? (
                  <FaArrowUp />
                ) : (
            ...
            <div className="w-full ">
              <ResponsiveContainer width={"100%"} height={345}>
                ...
                >
                  ...
                  <Area
                    type="monotone"
                    dataKey="otherAsset_current_value"
                    stroke="#975FEA"
...
export default OtherAssetsChart;
