...
const ProjectionSelect = ({ data, placeholder, getSelectedOpt, setId }) => {
  ...
  return (
    <div className={`relative h-[48px]`} ref={dropdownRef}>
      {value && (
        <div className="text-[#A8A8A8] text-[12px] text-roboto font-[400] tracking-[0.15px] absolute -top-5">
          {placeholder}
        </div>
      )}
      <div
      ...
      >
        {!value ? (
          ...
          <p className="mb-0 text-white text-[16px] font-[400] ">{value}</p>
        )}{" "}
        <img
