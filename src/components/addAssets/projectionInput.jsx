...
const ProjectionInput = (props) => {
  ...
  const inputClassName = `w-[100%] h-[42px]  border-b-2 outline-none px-0 bg-transparent text-neutral-700 text-white font-[400] text-[16px] placeholder-[16px] text-roboto tracking-tight-[0.15px]   ${
    ...
    <div className={`flex flex-col h-[48px] relative`}>
      ...
      {validation && (
        <div className="flex flex-col items-center self-start absolute top-[45px]">
          ...
          ></div>
          <div className="text-[12px] font-medium text-roboto text-center h-[22px] text-white px-10  rounded-[4px] bg-[#616161] flex justify-center items-center z-10">
            {errText}
          </div>
        </div>
      )}
