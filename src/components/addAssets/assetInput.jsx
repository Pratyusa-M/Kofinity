...
const AssetInput = (props) => {
  ...
  const inputClassName = `w-[100%] h-[42px]  border-b-2 outline-none px-0  text-neutral-700 text-white placeholder-[16px] text-roboto tracking-tight-[0.15px] bg-transp  ${
