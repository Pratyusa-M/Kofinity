...
import NoDataFoundChart from "./noDataFoundChart";
...
const CommonNetAssetvalueChart = ({
  strokeColor,
  fillColor,
  data,
  dataKey,
            ...
            <div className=" min-w-[500px] ">
              <ResponsiveContainer width={"100%"} height={345}>
                ...
                >
                  ...
                  <Area
                    type="step"
                    dataKey={dataKey ? dataKey : "uv"}
                    stroke={strokeColor ? strokeColor : "#975FEA"}
...
export default CommonNetAssetvalueChart;
